class PlaylistsController < ApplicationController
  ...
  def index
    @playlists = Kaminari.paginate_array(PlaylistDecorator.decorate_collection(Playlist.all.order('name'))).page(params[:page])
  end
  ...
  def playlist_params
    params.require(:playlist).permit(:name, :image, :description, :published, :kind_id, :user_id, song_ids: [], kind_ids: [], type_ids: [])
  end
